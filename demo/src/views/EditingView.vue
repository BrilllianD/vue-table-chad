 ...
 * Type 92 345 and the cell settles on 92 300 in one paint, because the table
 * waits for the response and adopts what came back. Turn *optimistic* on and it
 * takes two: your number, then the server's.
 *
