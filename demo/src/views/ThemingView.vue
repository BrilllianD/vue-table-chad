...
interface Palette {
  ...
  bgHeader: string
  /**
   * Header labels. The preset derives this from `textMuted` and `bgHeader` —
   * 90% of the first — so every palette here carries that mix rather than a
   * colour picked on its own: a header foreground chosen independently of the
   * two it sits between is the same white-on-white trap the file warns about
   * above.
   */
  textHeader: string
  bgSelected: string
...
const LIGHT: Palette = {
  ...
  bg: '#ffffff', bgHeader: '#f6f7f9', textHeader: '#747f8b',
...
const DARK: Palette = {
  ...
  bg: '#16191d', bgHeader: '#1e2228', textHeader: '#8e97a2',
...
const presets: Array<{ label: string; palette: Palette }> = [
  ...
  { label: 'Preset dark', palette: DARK },
  {
    ...
    palette: {
      ...
      bg: '#ffffff', bgHeader: '#f1f5f9', textHeader: '#728196',
  ...
  },
  {
    ...
    palette: {
      ...
      bg: '#ffffff', bgHeader: '#faf5ff', textHeader: '#8a79a4',
  ...
  },
  {
    ...
    palette: {
      accent: '#2563eb', accentContrast: '#ffffff',
      bg: '#ffffff', bgHeader: '#eef2f7', textHeader: '#747f8b',
  ...
  },
  {
    ...
    palette: {
      ...
      bg: '#ffffff', bgHeader: '#e8ece9', textHeader: '#697870',
  ...
  },
  {
    ...
    palette: {
      ...
      bg: '#ffffff', bgHeader: '#ffff00', textHeader: '#191900',
  ...
  },
  {
    ...
    palette: {
      ...
      bg: '#14101c', bgHeader: '#1d1729', textHeader: '#9689ae',
...
/**
 * The delta is only how `--vtc-row-hover-bg` is *derived*. Setting the variable
...
const alphaControls = [
  ...
  {
    key: 'selectedAlpha',
    label: '--vtc-row-selected-bg alpha',
    hint: 'selected rows',
    max: 100,
    overridden: () => false,
  },
...
<template>
  ...
  >
    ...
    <p class="hint">
      A palette is a set, not a list of independent knobs. Override <code>--vtc-header-bg</code>
